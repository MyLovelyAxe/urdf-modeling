...
#     4th leg:
#         /gurdy/4_1_joint_position_controller/command  head & yaw
#         /gurdy/4_2_joint_position_controller/command  yaw & upper
#         /gurdy/4_3_joint_position_controller/command  upper & lower
...
class gurdy_joint_mover():
    ...
    def __init__(self):
        ...
        self.pub_4th_head_yaw_joint = rospy.Publisher(
            '/gurdy/4_1_joint_position_controller/command', Float64, queue_size=1)
        self.pub_4th_yaw_upper_joint = rospy.Publisher(
            '/gurdy/4_2_joint_position_controller/command', Float64, queue_size=1)
        self.pub_4th_upper_lower_joint = rospy.Publisher(
            '/gurdy/4_3_joint_position_controller/command', Float64, queue_size=1)
    ...
    def move_gurdy_all_joints_with_angle(self, angle_1_1, angle_1_2, angle_1_3, angle_2_1, angle_2_2, angle_2_3, angle_3_1, angle_3_2, angle_3_3, angle_4_1, angle_4_2, angle_4_3):
        ...
        # 4th leg
        move_4_1 = Float64()
        move_4_1.data = angle_4_1
        self.pub_4th_head_yaw_joint.publish(move_4_1)

        move_4_2 = Float64()
        move_4_2.data = angle_4_2
        self.pub_4th_yaw_upper_joint.publish(move_4_2)

        move_4_3 = Float64()
        move_4_3.data = angle_4_3
        self.pub_4th_upper_lower_joint.publish(move_4_3)
    ...
    def movement_look(self, angle_1_1, angle_1_2, angle_1_3, angle_2_1, angle_2_2, angle_2_3, angle_3_1, angle_3_2, angle_3_3, angle_4_1, angle_4_2, angle_4_3):
        ...
        #     head_upperlegM4_yaw_joint  4_1
        #     head_upperlegM4_joint      4_2
        #     upperleg_lowerleg_M4_joint 4_3
        ...
        while not (similar_1_1 and similar_1_2 and similar_1_3 and similar_2_1 and similar_2_2 and similar_2_3 and similar_3_1 and similar_3_2 and similar_3_3 and similar_4_1 and similar_4_2 and similar_4_3):

            # move all joints
            self.move_gurdy_all_joints_with_angle(
                angle_1_1, angle_1_2, angle_1_3, angle_2_1, angle_2_2, angle_2_3, angle_3_1, angle_3_2, angle_3_3, angle_4_1, angle_4_2, angle_4_3)
            ...
            similar_4_1 = self.check_if_arrive_desirede_angle(
                'head_upperlegM4_yaw_joint', angle_4_1)
            similar_4_2 = self.check_if_arrive_desirede_angle(
                'head_upperlegM4_joint', angle_4_2)
            similar_4_3 = self.check_if_arrive_desirede_angle(
                'upperleg_lowerleg_M4_joint', angle_4_3)
    ...
    def initial_movement(self):
        ...
        self.movement_look(angle_1_1, angle_1_2, angle_1_3, angle_2_1,
                           angle_2_2, angle_2_3, angle_3_1, angle_3_2, angle_3_3, angle_4_1, angle_4_2, angle_4_3)
